...
def read_in_args():
    ...
    parser.add_argument("-x", "--width", help="set the width of the grid", default=30, type=int)
    parser.add_argument("-y", "--height", help="set the height of the grid", default=100, type=int)
    parser.add_argument("-p", "--poi", help="set the number of POIs", default=3, type=int)
    parser.add_argument("-c", "--chargers", help="set the number of existing chargers", default=6, type=int)
    parser.add_argument("-n", "--new-chargers", help="set the number of new chargers", default=7, type=int)
...
def set_up_scenario(w, h, num_poi, num_cs):
    ...
    charging_stations = [(28,77),(27,75),(12,11),(9,8),(21,54),(3,99)]
